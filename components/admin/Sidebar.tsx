...
import {
  ...
  MessageSquareText, BookOpen, Mail,
} from 'lucide-react';
...
const ADMIN_NAV = [
  ...
  { href: '/question-bank', icon: BookOpen,          label: 'Question Bank',    roles: ['super_admin', 'admin'] },
  { href: '/email-logs',    icon: Mail,              label: 'Email Logs',       roles: ['super_admin', 'admin'] },
